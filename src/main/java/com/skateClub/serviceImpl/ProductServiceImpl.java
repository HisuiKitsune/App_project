...
import com.skateClub.POJO.Product;
import com.skateClub.constants.ProductsConstants;
import com.skateClub.dao.ProductDao;
import com.skateClub.service.ProductService;
        ...
        try {
            ...
            if (jwtFilter.isAdmin()) {
                ...
                if (validateProductMap(requestMap, false)) {
                    ...
                    return ProdutosUtil.getResponseEntity("Product Added Successfully", HttpStatus.OK);
            ...
            if (jwtFilter.isAdmin()) {
                ...
                if (validateProductMap(requestMap, true)) {
                    ...
                    if (!optional.isEmpty()) {
                        ...
                        return ProdutosUtil.getResponseEntity("Product id doesn't not exist", HttpStatus.OK);
                    }
        ...
        try {
            ...
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return ProdutosUtil.getResponseEntity("Product Deleted Successfully", HttpStatus.OK);
        ...
        try {
            ...
            if (jwtFilter.isAdmin()) {
                ...
                if (!optional.isEmpty()) {
                    ...
                    return ProdutosUtil.getResponseEntity("Product Status Update Successfully", HttpStatus.OK);
